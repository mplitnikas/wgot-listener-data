...
This is a sample template for wgot-listeners-data - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name wgot-listeners-data \
...
```bash
sam logs -n HelloWorldFunction --stack-name wgot-listeners-data --tail
```
...
```bash
aws cloudformation delete-stack --stack-name wgot-listeners-data
```
